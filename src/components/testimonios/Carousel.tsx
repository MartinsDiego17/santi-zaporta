...
export const Carousel = () => {
    ...
    return (
        <div className="h-fit embla pb-[10vh] text-white" ref={emblaRef}>
                        ...
                        <div className='embla__slide' key={index}>
                            <section className='w-full flex justify-between place-items-center'>
                                ...
                                <article className='w-[50%]'>
                                    <img className='tab:h-[20vh] cel:h-[15vh] w-full max-h-[70vh] h-[50vh]' src={testimony.img} />
                                </article>
                                <article className='w-[50%]'>
                                    <img className='tab:h-[20vh] cel:h-[15vh] max-h-[70vh] w-full h-[50vh]' src={testimony.img} />
                                </article>
            ...
            <div className='tab:transform tab:scale-150 flex justify-center gap-x-4'>
